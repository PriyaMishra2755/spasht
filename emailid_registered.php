...
margin-left:200px;padding: 10px 20px 20px 20px;font-family:candara; font-size:1.5em;">
<p style="float:right; "><b>SIGNUP</b></p>
<p style="clear:both;"></p>
...
<tr><td colspan="2" style="color:red;font-size:0.8em"><center>This email id already exists</center></td></tr>
...
<tr><td>City:   </td><td> <input type="text" name="city" placeholder="Address" style="border-radius:5px; height: 25px; font-size:1.0em;" required/></td></tr></table>
<br>
